...
import { InstagramStoriesPageClient } from '@/components/InstagramStoriesPageClient';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const meta = getPageMeta(validLocale, 'instagramStories');
  const alternates = getAlternatesForPageWithLocale(validLocale, 'instagramStories');
  return {
    title: meta.title,
...
export default function InstagramStoriesPage() {
  return <InstagramStoriesPageClient />;
}
