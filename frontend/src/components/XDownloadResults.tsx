        ...
        <div className="flex flex-col sm:flex-row gap-5 sm:gap-6">
          ...
          <div className="flex-1 min-w-0 flex flex-col">
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-2">
              ...
              {quality && (
                <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-stone/15 dark:bg-stone/30 text-stone-700 dark:text-stone-300 text-xs font-medium">
                  {quality}
                </span>
              )}
              {duration != null && duration > 0 && !cover && (
