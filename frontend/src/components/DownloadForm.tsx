      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex-1 min-w-0 relative">
          <input
            ...
            disabled={loading}
            className="w-full px-4 py-3 md:py-3.5 pr-10 rounded-lg border border-stone/30 dark:border-stone/50 bg-white dark:bg-stone/20 text-charcoal dark:text-cream placeholder-stone/60 focus:border-gold focus:ring-1 focus:ring-gold transition-colors disabled:opacity-60"
            aria-invalid={!!error}
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-6 py-3 md:py-3.5 rounded-lg bg-charcoal dark:bg-cream text-cream dark:text-charcoal font-medium hover:bg-charcoal/90 dark:hover:bg-cream/90 focus:ring-2 focus:ring-gold focus:ring-offset-2 transition-colors disabled:opacity-60 disabled:cursor-not-allowed shrink-0"
        >
          {loading ? (
